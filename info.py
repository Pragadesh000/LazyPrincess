...
BOT_TOKEN = environ['BOT_TOKEN', '5747385938:AAGhjntK8cI2Jf_3r4iJeGshAoysb0ILt78']
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '1899869233').split()]
LAZY_RENAMERS = (lazy_renamers + ADMINS) if lazy_renamers else []
REQ_CHANNEL = int(environ.get("REQ_CHANNEL", '-1001920331070'))
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','pragade2') # WITHOUT @
...
SELF_DELETE_SECONDS = int(environ.get('SELF_DELETE_SECONDS', 800))
